...
- `CLOSE_COOLIFY_REALTIME_PORTS=true`: realtime uses effective domain on `443` (`COOLIFY_REALTIME_DOMAIN` or `COOLIFY_PUBLIC_DOMAIN` fallback); compose hardening + `DOCKER-USER` guards block direct public `6001/6002`.
