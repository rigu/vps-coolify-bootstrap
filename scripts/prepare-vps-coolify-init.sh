...
content="${content//DEVOPS_USER_NOPASSWD_HERE/${cfg[DEVOPS_USER_NOPASSWD]}}"
content="${content//DOCKER_USERS_HERE/${cfg[DOCKER_USERS]}}"
content="${content//MANAGEMENT_CIDRS_HERE/${cfg[MANAGEMENT_CIDRS]}}"
content="${content//EXTRA_ALLOWED_TCP_PORTS_HERE/${cfg[EXTRA_ALLOWED_TCP_PORTS]}}"
content="${content//EXTRA_ALLOWED_UDP_PORTS_HERE/${cfg[EXTRA_ALLOWED_UDP_PORTS]}}"
...
for token in TIMEZONE_HERE SSH_PORT_HERE DEVOPS_USER_HERE DEVOPS_USER_SUDO_SPEC_HERE COOLIFY_SUDO_NOPASSWD_USER_HERE DEVOPS_SSH_AUTHORIZED_KEYS_BLOCK_HERE BOOTSTRAP_SSH_PUBLIC_KEY_HERE SSH_KEY_ROTATE_HERE ADDITIONAL_SUDO_USERS_HERE DEVOPS_USER_NOPASSWD_HERE DOCKER_USERS_HERE MANAGEMENT_CIDRS_HERE EXTRA_ALLOWED_TCP_PORTS_HERE EXTRA_ALLOWED_UDP_PORTS_HERE CLOSE_COOLIFY_REALTIME_PORTS_HERE DOCKER_DISABLE_IPV6_FOR_PARSEADDR_FIX_HERE COOLIFY_REALTIME_DOMAIN_HERE COOLIFY_PUBLIC_DOMAIN_HERE COOLIFY_ROOT_USERNAME_HERE COOLIFY_ROOT_USER_EMAIL_HERE COOLIFY_ROOT_USER_PASSWORD_HERE USER_PASSWORDS_ENCRYPTION_PASSWORD_HERE BOOTSTRAP_REPO_URL_HERE BOOTSTRAP_REPO_REF_HERE BOOTSTRAP_EXPECTED_SHA_HERE; do
