...
for token in TIMEZONE_HERE SSH_PORT_HERE PRIMARY_SUDO_USER_HERE SECONDARY_SUDO_USER_HERE SSH_PUBLIC_KEY_HERE SSH_KEY_ROTATE_HERE CREATE_USERS_HERE SUDO_USERS_HERE DOCKER_USERS_HERE COOLIFY_GROUP_USERS_HERE COOLIFY_PUBLIC_DOMAIN_HERE COOLIFY_ROOT_USERNAME_HERE COOLIFY_ROOT_USER_EMAIL_HERE COOLIFY_ROOT_USER_PASSWORD_HERE USER_PASSWORDS_ENCRYPTION_PASSWORD_HERE BOOTSTRAP_REPO_URL_HERE BOOTSTRAP_REPO_REF_HERE; do
